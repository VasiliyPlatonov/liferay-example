 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link ru.xdsoft.fips.intranet.portal.filetree.service.impl.FolderLocalServiceImpl}.
 * </p>
 *
 * @author Vasiliy Platonov
 * @see ru.xdsoft.fips.intranet.portal.filetree.service.impl.FolderLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class FolderLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements FolderLocalService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FolderLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ru.xdsoft.fips.intranet.portal.filetree.service.FolderLocalServiceUtil</code>.
	 */
	...
	public Folder createFolder(long id) {
		return folderPersistence.create(id);
	}
	...
	public Folder deleteFolder(long id) throws PortalException {
		return folderPersistence.remove(id);
	}
	...
	public Folder fetchFolder(long id) {
		return folderPersistence.fetchByPrimaryKey(id);
	}
	...
	public Folder fetchFolderByUuidAndGroupId(String uuid, long groupId) {
		return folderPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public Folder getFolder(long id) throws PortalException {
		return folderPersistence.findByPrimaryKey(id);
	}
	...
	public List<Folder> getFoldersByUuidAndCompanyId(
		...
		return folderPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<Folder> getFoldersByUuidAndCompanyId(
		...
		return folderPersistence.findByUuid_C(
	...
	public Folder getFolderByUuidAndGroupId(String uuid, long groupId)
		...
		return folderPersistence.findByUUID_G(uuid, groupId);
	}
