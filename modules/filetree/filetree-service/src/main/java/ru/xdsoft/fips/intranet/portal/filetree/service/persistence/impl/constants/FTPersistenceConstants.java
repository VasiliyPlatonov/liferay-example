...
package ru.xdsoft.fips.intranet.portal.filetree.service.persistence.impl.constants;
 ...
 * @generated
 */
public class FTPersistenceConstants {

	public static final String BUNDLE_SYMBOLIC_NAME =
		"ru.xdsoft.fips.intranet.portal.filetree.service";

	public static final String ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER =
		"(origin.bundle.symbolic.name=" + BUNDLE_SYMBOLIC_NAME + ")";

	static {
		Bundle bundle = FrameworkUtil.getBundle(FTPersistenceConstants.class);
