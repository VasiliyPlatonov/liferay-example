 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the <code>guestbook.service.GuestbookEntryLocalService</code> interface.
 *
 * <p>
...
public class GuestbookEntryLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Use <code>guestbook.service.GuestbookEntryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>guestbook.service.GuestbookEntryLocalServiceUtil</code>.
	 */
